...
output "line_message_batch" {
  value = {
    arn  = aws_ecr_repository.line_message_batch.arn
    id   = aws_ecr_repository.line_message_batch.id
    name = aws_ecr_repository.line_message_batch.name
    url  = aws_ecr_repository.line_message_batch.repository_url
  }
}
