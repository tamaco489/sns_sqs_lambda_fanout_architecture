...
import (
	...
	"github.com/tamaco489/sns_sqs_lambda_fanout_architecture/batch/line_message/internal/handler"
	"github.com/tamaco489/sns_sqs_lambda_fanout_architecture/batch/line_message/internal/library/logging"
...
func main() {
	...
	lambda.Start(handler.TimeoutMiddleware(handler.LineMessageHandler(*job)))
}
